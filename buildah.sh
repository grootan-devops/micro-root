...
curl --fail --show-error --location --proto '=https' --tlsv1.2 --retry 3 --output "${CONTAINER_MOUNT}/usr/bin/dumb-init" "https://github.com/Yelp/dumb-init/releases/download/v${DUMB_INIT_VERSION}/dumb-init_${DUMB_INIT_VERSION}_x86_64"
